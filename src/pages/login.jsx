...
import { login,login_failed } from '../features/userSlice'
...
export default function Login() {
  ...
  const submit = (e) => {
    ...
    dispatch(login({email:email.value ,password:pass.value}))
    }

  // // if user authentcited
  const is_auth = useSelector(state=>state.user.isAuthenticated)
  const err = useSelector(state=>state.error)
  console.log(is_auth)
  

  return is_auth == true ?(<Navigate to="/"/>) :  (
    <div>
